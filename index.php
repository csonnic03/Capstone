  ...
  <body>
    ...
    <?php
      ...
      <div class="row">
        ...
        <div class="col">
          <p>At SkateWave, we have SkateBoards, Skating Gear, Surfboards, and Surfboarding Gear. We have a range of different brands and types of Skateboards and Surfboards. We also sell skateboarding helmets, elbow, knee and wrist guards. We have a variety of products that is meant for skateboarding and surfboarding. We have everything that relates to the surfing and skating. So come on and look around our store.</p>
        </div>
        <div class="col">
        </div>
      </div>
